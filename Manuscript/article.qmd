...
which may be unfamiliar to readers without a computer science background, in the
Glossary (Appendix C). When these differ from the originals, code may
...
Glossary). Workflow orchestration tools such as {targets} [@landau_2021] and Make
