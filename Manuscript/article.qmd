...
::: {.callout-note}
JG: I wonder: Do we include the 2026 paper on reproducibility? https://www.nature.com/articles/s41586-026-10251-x. 
:::
...
::: {.callout-note}
JG: why run nix-build and then show them the packages needed later on? Why not add from earlier step? I think this should be way earlier.
:::
