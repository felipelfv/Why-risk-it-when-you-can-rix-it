...
Psychology and Neuroscienc, Boston College},{Statistics and Data
...
researchers may implicitly target different points on this continuum,
and efforts to improve reproducibility can diverge substantially in both
goals and implementation.

Open science initiatives have made considerable progress in encouraging
movement along this spectrum. For example, journals now offer
open-science badges (\citeproc{ref-kidwell_etall_2016}{Kidwell et al.,
2016}), best practices have been developed to make data sharing routine
(\citeproc{ref-levenstein_lyle_2018}{Levenstein \& Lyle, 2018}), and
platforms such as the Open Science Framework (OSF) provide
infrastructure for storing and sharing research materials
(\citeproc{ref-nosek_etall_2015}{Nosek et al., 2015}). However, these
efforts primarily target the lower to middle portions of the continuum,
emphasizing \emph{what} is shared rather than \emph{how} shared
materials can be executed in practice.

Data and code are never fully self-sufficient to reproduce a set of
findings (\citeproc{ref-epskamp_2019}{Epskamp, 2019};
\citeproc{ref-peikert_brandmaier_2021}{Peikert \& Brandmaier, 2021};
\citeproc{ref-wiebels_moreau_2021}{Wiebels \& Moreau, 2021};
\citeproc{ref-ziemann_etall_2023}{Ziemann et al., 2023}). Assuming the
data and code are error-free, reproducibility depends on a hierarchy of
software components---collectively referred to as
\emph{dependencies}---including the programming language version, the
...
orchestration system or to prescribe a particular analytic structure.
Instead, we aim to show what Nix and \{rix\} are and how they can
establish a stable, cross-platform environment within which any
simulation study---whether organized in simple, documented script
sequences (e.g., .R files that \texttt{source()} others), through more
formal orchestration tools (e.g., \{targets\}) or embedded as code
...
Manuscript\footnote{See the \{rix\} documentation for more:
  \url{https://docs.ropensci.org/rix/articles/literate-programming.html}}}{Reproducing the Complete Manuscript}}\label{reproducing-the-complete-manuscript6}
